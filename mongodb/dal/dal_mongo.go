...
type DataAccessLayerMongoDB struct {
...
func NewDataAccessLayerMongoDB(ctx context.Context, config *config.DatabaseConfig) (DataAccessLayer, error) {
	dal := &DataAccessLayerMongoDB{
		dbConfig: config,
	}
...
func (dal *DataAccessLayerMongoDB) GetClient(ctx context.Context) (interface{}, error) {
	//Perform connection creation operation only once.
	var err error
	mongoOnce.Do(func() {
		// Set client options
		clientOptions := options.Client().ApplyURI(dal.dbConfig.ConnectionURI).
...
func (dal *DataAccessLayerMongoDB) GetCollection(collectionName string) (*mongo.Collection, error) {
	return dal.dbInstance.Collection(collectionName), nil
}

// Insert a new document in the collection.
func (dal *DataAccessLayerMongoDB) Insert(ctx context.Context, collectionName string, data interface{}) (interface{}, error) {
...
func (dal *DataAccessLayerMongoDB) InsertMany(ctx context.Context, collectionName string, data []interface{}) ([]interface{}, error) {
	//Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
...
func (dal *DataAccessLayerMongoDB) Update(ctx context.Context, collectionName string, filter interface{}, data interface{}, upsert bool) error {
	//Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// options
	opts := options.Update()
...
// Update a document in the collection.
func (dal *DataAccessLayerMongoDB) UpdateMany(ctx context.Context, collectionName string, filter interface{}, data interface{}, upsert bool) error {
	//Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// options
	opts := options.Update()
...
func (dal *DataAccessLayerMongoDB) Delete(ctx context.Context, collectionName string, filter interface{}) error {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
...
func (dal *DataAccessLayerMongoDB) DeleteMany(ctx context.Context, collectionName string, filter interface{}) error {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
...
func (dal *DataAccessLayerMongoDB) Find(ctx context.Context, collectionName string, filter, projection, sort interface{}, offset, limit int64) ([]interface{}, error) {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// options
	opts := options.Find()
...
func (dal *DataAccessLayerMongoDB) FindAll(ctx context.Context, collectionName string, projection, sort interface{}) ([]interface{}, error) {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// options
	opts := options.Find()
...
func (dal *DataAccessLayerMongoDB) FindOne(ctx context.Context, collectionName string, filter, projection interface{}) (interface{}, error) {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// options
...
func (dal *DataAccessLayerMongoDB) Distinct(ctx context.Context, collectionName string, field string, filter interface{}) ([]interface{}, error) {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// Perform find operation & validate against the error.
...
func (dal *DataAccessLayerMongoDB) FindByID(ctx context.Context, collectionName string, id interface{}, projection interface{}) (interface{}, error) {
	// filter
...
// Aggregate
func (dal *DataAccessLayerMongoDB) Aggregate(ctx context.Context, collectionName string, filter, projection, sort interface{}, offset, limit int64) ([]interface{}, error) {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// create pipeline
...
func (dal *DataAccessLayerMongoDB) parsePipelineJSON(str string) (mongo.Pipeline, error) {
	var pipeline = []bson.D{}
...
// Aggregate common
func (dal *DataAccessLayerMongoDB) AggregateCommon(ctx context.Context, collectionName string, pipeline interface{}) ([]interface{}, error) {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
...
func (dal *DataAccessLayerMongoDB) Counts(ctx context.Context, collectionName string, filter interface{}) (int64, error) {
	// Create a handle to the respective collection in the database.
	collection := dal.dbInstance.Collection(collectionName)
	// Perform find operation & validate against the error.
